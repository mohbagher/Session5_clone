...
def generate_limited_probing_dataset(
    ...
    """
    Generate dataset with hybrid physics engine and configurable probing.
    """
...
def create_dataloaders(config: Config,
    ...
    train_data = generate_limited_probing_dataset(
        ...
        normalize=data_config.normalize_input, seed=data_config.seed,
    ...
    val_data = generate_limited_probing_dataset(
        ...
        normalize=data_config.normalize_input, seed=data_config.seed + 1,
        matlab_data=val_mat,
        selection_method=selection_method,
        selector_fn=selector_fn
    )
    ...
    test_data = generate_limited_probing_dataset(
        ...
        normalize=data_config.normalize_input, seed=data_config.seed + 2,
